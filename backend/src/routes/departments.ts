    ...
    try {
        const departments = await prisma.department.findMany({
            ...
            include: {
                ...
                doctors: { where: { isActive: true }, select: { id: true, name: true, title: true, specialty: true, image: true } }
            }
        });
    ...
    try {
        ...
        const dept = await prisma.department.create({
            data: {
                ...
                categoryName: category, // mapping legacy 'category' from frontend to 'categoryName'
                categoryId,
                vision, mission, goal,
