...
const mockPosts = [
    {
        ...
        `,
        featuredImage: `${backendUrl}/uploads/hospital_legacy_building.png`,
        type: 'NEWS',
        status: 'PUBLISHED',
    ...
    },
    {
        ...
        `,
        featuredImage: `${backendUrl}/uploads/psychiatry_consultation.png`,
        type: 'NEWS',
        status: 'PUBLISHED',
    ...
    },
    {
        ...
        featuredImage: `${backendUrl}/uploads/mental_health_awareness.png`,
        type: 'NEWS',
        status: 'PUBLISHED',
...
async function main() {
    ...
    const authorId = admin?.id || 'cmlux3st9000020sdshmhqif9';

    console.log('Seeding news posts with high-quality local assets...');
