...
INSERT INTO `forms` (`id`, `title`, `description`, `fields`, `isActive`, `isPublic`, `createdAt`, `updatedAt`)
VALUES (
...
-- ============================================================
-- 6. CLINICAL ATTACHMENT PRICING SETTINGS
-- ============================================================
INSERT INTO `site_settings` (`id`, `key`, `value`, `type`, `group`, `label`, `createdAt`, `updatedAt`)
VALUES ('clinical-eth-price', 'clinical_attachment_eth_price', '2500', 'number', 'clinical_attachment', 'Clinical Attachment Price (Ethiopian - ETB)', NOW(), NOW())
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updatedAt` = NOW();

INSERT INTO `site_settings` (`id`, `key`, `value`, `type`, `group`, `label`, `createdAt`, `updatedAt`)
VALUES ('clinical-int-price', 'clinical_attachment_int_price', '5000', 'number', 'clinical_attachment', 'Clinical Attachment Price (International - ETB)', NOW(), NOW())
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updatedAt` = NOW();
