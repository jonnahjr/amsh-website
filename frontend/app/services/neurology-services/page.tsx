...
const units = [
    { id: '01', name: 'Neurology Outpatient Clinic', badge: 'Outpatient', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Specialist consultation for neurological disorders including epilepsy, headache syndromes, Parkinson\'s disease, peripheral neuropathy, and movement disorders. Clinic runs with referral and walk-in options.' },
    { id: '02', name: 'Epilepsy Management Unit', badge: 'Specialist', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Dedicated management of epilepsy — Ethiopia\'s most common neurological condition — including medication optimization, seizure diary monitoring, triggers counseling, and anti-epileptic drug (AED) therapy.' },
    { id: '03', name: 'Neurological Investigations', badge: 'Diagnostic', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Comprehensive diagnostic panel including EEG studies, nerve conduction studies (NCS), and coordination with radiology for brain MRI/CT imaging to support clinical neurological assessment.' },
    { id: '04', name: 'Neuro-Psychiatric Liaison', badge: 'Integrated', color: 'bg-slate-900', accent: 'text-slate-300', badgeColor: 'bg-slate-300/10 text-slate-300', desc: 'Specialized liaison service bridging neurology and psychiatry for patients with neuropsychiatric presentations — including temporal lobe disorders, psychosis related to neurological disease, and cognitive-behavioral overlap conditions.' },
];

const stats = [
    { value: 'Expert', label: 'Neurologist-Led', icon: '🔬' },
    { value: 'EEG', label: 'On-Site Studies', icon: '⚡' },
    { value: 'Epilepsy', label: 'Core Specialty', icon: '🧠' },
    { value: 'Linked', label: 'Neuro-Psych Care', icon: '🔗' },
];

export default function NeurologyServicesPage() {
    return (
        <>
            <EmergencyBanner />
            <Navbar />
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Neurology <br /><span className="text-gray-400 italic font-medium">Services</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Specialized diagnosis and evidence-based management of brain, spine, and peripheral nervous system disorders, with particular expertise in epilepsy and neuropsychiatric conditions.
                            </p>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                <a href="tel:+2511118685385" className="px-10 py-5 bg-white text-blue-950 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-blue-50 transition-all shadow-2xl hover:-translate-y-1 flex items-center gap-2">
                                    <PhoneIcon className="w-5 h-5" /> Book Appointment
                                </a>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">EEG · Epilepsy · Neuro-Psychiatry · Movement Disorders</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter shadow-xs">Expert Care for the<br /><span className="text-blue-900">Nervous System</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>EMSH Neurology Services offers comprehensive clinical evaluation and management of neurological disorders. Led by specialist neurologists with access to on-site EEG equipment, our team manages a wide spectrum of conditions affecting the brain, spinal cord, and peripheral nerves.</p>
                                    <p>Our unique integration of neurology and psychiatry enables management of complex neuropsychiatric conditions that require both disciplines — a clinical strength rare in the East African region.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Epilepsy Management', 'EEG Monitoring', 'Headache & Migraine', 'Stroke Follow-up', 'Neuropathy', 'Cognitive Disorders'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Neurology Department</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Neurology Clinic</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    <div className="text-2xl font-black">EEG</div>
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">On-Site</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Neurology Units</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">Four specialized neurology units delivering expert diagnostic and therapeutic services.</p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter shadow-sm">Book a Neurology Consultation</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">Referrals accepted from all health facilities. Walk-in neurological emergencies assessed without appointment.</p>
