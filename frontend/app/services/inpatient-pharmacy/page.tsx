...
const features = [
    { id: '01', name: 'Unit-Dose Dispensing System', badge: 'Safety', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Medications are prepared and dispensed in individual unit-dose packages for each patient, eliminating dispensing errors and ensuring the correct drug, dose, and route reaches every patient on every administration.' },
    { id: '02', name: 'IV Admixture & Preparation', badge: 'Sterile', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Sterile preparation of intravenous medications, parenteral nutrition, chemotherapy agents, and complex admixtures under laminar flow hoods in the pharmacy clean room, following strict aseptic technique and quality standards.' },
    { id: '03', name: 'Ward-Based Pharmacist Rounds', badge: 'Clinical', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Clinical pharmacists conduct daily ward rounds alongside the multidisciplinary team, reviewing prescriptions for drug interactions, dose appropriateness, side effect management, and medication reconciliation at admission and discharge.' },
    { id: '04', name: '24/7 Emergency Dispensing', badge: '24/7', color: 'bg-red-950', accent: 'text-red-400', badgeColor: 'bg-red-400/10 text-red-400', desc: 'Round-the-clock emergency dispensing service ensuring critical medications — including controlled substances, resuscitation drugs, and urgent psychiatric medications — are available immediately when needed by the clinical team, day or night.' },
];

const stats = [
    { value: '24/7', label: 'Dispensing Service', icon: '🏨' },
    { value: 'Unit', label: 'Dose System', icon: '💊' },
    { value: 'Ward', label: 'Pharmacist Rounds', icon: '👩‍⚕️' },
    { value: 'Sterile', label: 'IV Preparation', icon: '🧪' },
];

export default function InpatientPharmacyPage() {
    return (
        <>
            <EmergencyBanner />
            <Navbar />
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Inpatient <br /><span className="text-gray-400 italic font-medium">Pharmacy</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Ensuring safe and timely medication administration for every hospitalized patient — 24 hours a day, 7 days a week — with clinical pharmacists embedded in the ward team.
                            </p>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                <a href="tel:+2511118685385" className="px-10 py-5 bg-white text-blue-950 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-blue-50 transition-all shadow-2xl hover:-translate-y-1 flex items-center gap-2">
                                    <PhoneIcon className="w-5 h-5" /> Contact Pharmacy
                                </a>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">24/7 Dispensing · Unit-Dose · IV Preparation · Ward Pharmacist</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">Safe Medication <br /><span className="text-blue-900">Around the Clock</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>The Inpatient Pharmacy is the pharmaceutical backbone of EMSH's inpatient care — responsible for preparing, dispensing, and monitoring medications for every patient across all wards, including psychiatric units, ICU, HDU, and medical wards.</p>
                                    <p>Our unit-dose dispensing system, clinical pharmacist ward rounds, and 24/7 emergency dispensing service create a comprehensive medication safety net that ensures every patient receives the right drug, at the right dose, at the right time — every time.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Controlled Drug Management', 'Prescription Validation', 'Drug Interaction Screening', 'Medication Reconciliation', 'Emergency Resus Drugs', 'Parenteral Nutrition'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Inpatient Pharmacy</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Ward Pharmacy</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    ...
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">Dispensing</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            <span className="section-badge mb-4">🏨 Inpatient Services</span>
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Inpatient Pharmacy Services</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Four core inpatient pharmacy services ensuring medication safety, accuracy, and availability for all hospitalized patients.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">Inpatient Pharmacy Enquiries</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                For medication queries, prescription clarifications, or drug information, our clinical pharmacists are available around the clock.
                            </p>
