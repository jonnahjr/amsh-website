...
import { PhoneIcon, ArrowRightIcon, CheckCircleIcon, BuildingOffice2Icon, UsersIcon } from '@heroicons/react/24/outline';

const units = [
    { id: '01', name: 'Medical Social Work Team', badge: 'Inpatient', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Comprehensive social assessment and intervention for inpatients addressing housing, family dynamics, financial barriers, employment, and access to community support networks that impact mental health and recovery.' },
    { id: '02', name: 'Family Counseling & Support', badge: 'Family', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Structured family sessions providing education about mental illness, coping strategies, conflict resolution, caregiver burden assessment, and support for families navigating life with a loved one with a psychiatric condition.' },
    { id: '03', name: 'Discharge Planning & Reintegration', badge: 'Discharge', color: 'bg-emerald-950', accent: 'text-emerald-400', badgeColor: 'bg-emerald-400/10 text-emerald-400', desc: 'Comprehensive discharge planning including community referrals, housing coordination, follow-up scheduling, medication supply arrangements, and linkage to outpatient support services ensuring a safe transition from hospital to community.' },
    { id: '04', name: 'Community Linkage & Advocacy', badge: 'Outreach', color: 'bg-slate-900', accent: 'text-slate-300', badgeColor: 'bg-slate-300/10 text-slate-300', desc: 'Advocacy for patients\' rights, social entitlements, and access to community-based rehabilitation services. Liaison with NGOs, government agencies, and peer support networks to facilitate comprehensive post-discharge support.' },
];

const stats = [
    { value: 'Holistic', label: 'Social Assessment', icon: '🤝' },
    { value: 'Family', label: 'Centred Care', icon: '👨‍👩‍👧' },
    { value: 'Safe', label: 'Discharge Planning', icon: '🏠' },
    { value: 'Global', label: 'Support Standards', icon: '🌍' },
];
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Social <br /><span className="text-gray-400 italic font-medium">Services</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Holistic support for patients and families — addressing social, economic, and community reintegration needs as essential components of psychiatric recovery.
                            </p>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                <a href="tel:+2511118685385" className="px-10 py-5 bg-white text-blue-950 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-blue-50 transition-all shadow-2xl hover:-translate-y-1 flex items-center gap-2">
                                    <PhoneIcon className="w-5 h-5" /> Contact Social Work
                                </a>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Social Work · Family Support · Discharge Planning · Community Linkage</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">Healing Beyond <br /><span className="text-blue-900">Clinical Borders</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>Psychiatric recovery is not just a clinical process; it is a social one. At EMSH, our Social Services department addresses the complex social determinants of mental health, ensuring that patients have the support systems, resources, and community linkage necessary for sustainable recovery.</p>
                                    <p>We work closely with families, community leaders, and social organizations to reduce stigma, facilitate reintegration after hospitalization, and advocate for the rights and dignity of every individual under our care.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Social Assessment', 'Family Liaison', 'Financial Advocacy', 'Housing Coordination', 'Legal Rights Support', 'Community Bridge Planning'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    <div className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center border border-white/10"><UsersIcon className="w-10 h-10 text-blue-300" /></div>
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Social Services Unit</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Patient Advocacy Center</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    ...
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">Network</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Social Service Programs</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Four integrated programs addressing the full social care pathway from inpatient assessment to community reintegration.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">Social Services Referral</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">Referrals accepted from all clinical staff. Family members may also contact our social work team directly.</p>
