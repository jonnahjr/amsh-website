...
const features = [
    { id: '01', name: 'Prescription Dispensing', badge: 'Outpatient', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Accurate dispensing of psychiatric and general medical prescriptions for all clinic patients, following a rigorous verification process to ensure patient safety and therapeutic efficacy.' },
    { id: '02', name: 'Medication Counseling', badge: 'Expert Guidance', color: 'bg-emerald-950', accent: 'text-emerald-400', badgeColor: 'bg-emerald-400/10 text-emerald-400', desc: 'Pharmacist-led sessions providing detailed explanations of medication usage, potential side effects, importance of adherence, and how to manage treatment at home for better outcomes.' },
    { id: '03', name: 'Psychoeducation Liaison', badge: 'Patient Support', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Collaborating with the clinical team to provide integrated psychoeducation, helping patients and caregivers understand the role of medications in the recovery journey and reducing stigma associated with psychiatric treatment.' },
    { id: '04', name: 'Adherence Monitoring', badge: 'Clinical Excellence', color: 'bg-slate-900', accent: 'text-slate-300', badgeColor: 'bg-slate-300/10 text-slate-300', desc: 'Ongoing monitoring of outpatient treatment adherence, identifying barriers to medication compliance and providing practical strategies to help patients stay on track with their prescribed therapy.' },
];

const stats = [
    { value: 'Daily', label: 'Outpatient Service', icon: '💊' },
    { value: 'Expert', label: 'Clinical Counseling', icon: '👩‍⚕️' },
    { value: 'Safe', label: 'Drug Verification', icon: '🛡️' },
    { value: 'Full', label: 'Psychiatric Formulary', icon: '📦' },
];

export default function OutpatientPharmacyPage() {
    return (
        <>
            <EmergencyBanner />
            <Navbar />
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Outpatient <br /><span className="text-gray-400 italic font-medium">Pharmacy</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Dedicated pharmaceutical care for clinic patients — providing expert dispensing, professional medication counseling, and adherence support to ensure treatment success.
                            </p>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Dispensing · Counseling · Adherence · Psychiatric Formulary</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">Professional Care in <br /><span className="text-blue-900">Every Prescription</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>The Outpatient Pharmacy at EMSH is more than just a dispensing unit; it is a vital part of the therapeutic process for thousands of patients visiting our clinics. We specialize in psychiatric pharmacology, ensuring that patients receive medications that are verified for safety and effectiveness.</p>
                                    <p>Our expert pharmacists provide comprehensive counseling, helping patients and their families understand their treatment plans, manage potential side effects, and maintain the steady adherence necessary for successful mental health recovery.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Prescription Verification', 'Clinical Counseling', 'Medication Psychoeducation', 'Adherence Support', 'Drug Information Service', 'Specialist Formulary'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Outpatient pharmacy Unit</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH OPD Pharmacy Corner</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    <div className="text-2xl font-black">Clinical</div>
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">Pharmacy</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            <span className="section-badge mb-4">💊 Our Service Units</span>
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Pharmacy Operations</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Integrated outpatient pharmacy services focused on patient safety and therapeutic success.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">Pharmacy Care Information</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                Outpatient pharmacy services are available during clinical hours from Monday to Friday.
                            </p>
