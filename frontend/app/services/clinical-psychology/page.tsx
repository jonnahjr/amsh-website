...
const units = [
    { id: '01', name: 'Psychological Assessment Clinic', badge: 'Assessment', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Comprehensive neuropsychological and psychometric assessment using internationally validated instruments (MMSE, WAIS, PHQ-9, GAD-7, PANSS, BPRS) to guide diagnosis, treatment planning, and disability evaluation.' },
    { id: '02', name: 'Individual Psychotherapy', badge: 'One-on-One', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Evidence-based individual therapy including Cognitive Behavioural Therapy (CBT), Dialectical Behaviour Therapy (DBT), Motivational Interviewing, and Supportive Psychotherapy for depression, anxiety, trauma, and personality disorders.' },
    { id: '03', name: 'Group Psychotherapy Program', badge: 'Group', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Structured therapeutic groups for patients with shared presentations — including psychoeducation groups, social skills training, anger management, relapse prevention, and mindfulness-based interventions.' },
    { id: '04', name: 'Neuropsychological Rehabilitation', badge: 'Rehabilitation', color: 'bg-slate-900', accent: 'text-slate-300', badgeColor: 'bg-slate-300/10 text-slate-300', desc: 'Targeted cognitive rehabilitation for patients with memory impairment, executive dysfunction, and cognitive decline associated with psychiatric illness, substance use, neurological conditions, or post-ICU recovery.' },
];

const stats = [
    { value: 'CBT', label: 'Primary Modality', icon: '🧠' },
    { value: 'Individual +', label: 'Group Therapy', icon: '👥' },
    { value: 'Validated', label: 'Assessment Tools', icon: '📋' },
    { value: 'Expert', label: 'Clinical Psychologists', icon: '👩‍⚕️' },
];
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Clinical <br /><span className="text-gray-400 italic font-medium">Psychology</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Psychological assessment, evidence-based psychotherapy, and neuropsychological rehabilitation delivered by experienced clinical psychologists — an essential component of holistic mental health care.
                            </p>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">CBT · DBT · Group Therapy · Neuropsychological Assessment</span>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">
                                    The Science of the Mind <br /><span className="text-blue-900">Applied to Healing</span>
                                </h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>
                                        Clinical psychology is a core pillar of EMSH's therapeutic offering, providing the non-pharmacological treatments that are often the most effective interventions for many psychiatric conditions. Our clinical psychologists work within the multidisciplinary team, complementing medical and nursing care with specialized psychological assessment and therapy.
                                    </p>
                                    <p>
                                        Psychotherapy is evidence-based and tailored to each individual's presentation, cultural context, and treatment goals — with modalities selected based on international clinical guidelines and the patient's specific needs.
                                    </p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Cognitive Behavioural Therapy', 'Trauma-Focused CBT', 'Dialectical Behaviour Therapy', 'Mindfulness-Based Therapy', 'Psychometric Testing', 'Family Therapy'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Psychology Department</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Therapy Suite</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    <div className="text-2xl font-black">CBT</div>
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">& More</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Psychology Programs</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Four specialized clinical psychology programs covering assessment, individual therapy, group therapy, and neuropsychological rehabilitation.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">Book a Psychology Session</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">Referrals accepted from specialists and other clinical staff. Self-referrals also welcome for outpatient sessions.</p>
