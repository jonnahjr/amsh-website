...
const units = [
    { id: '01', name: 'Clinical Chemistry Laboratory', badge: 'Biochemistry', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Full biochemistry panel including LFTs, RFTs, electrolytes, glucose, lipid profiles, thyroid function tests, and medication drug-level monitoring essential for psychiatric and medical patient management.' },
    { id: '02', name: 'Hematology Laboratory', badge: 'Blood Studies', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Complete blood count (CBC), erythrocyte sedimentation rate (ESR), coagulation studies, and blood film analysis to detect anemia, infection, hematological disorders, and drug-induced blood dyscrasias.' },
    { id: '03', name: 'Microbiology & Serology', badge: 'Infection', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Culture and sensitivity testing, HIV rapid testing, hepatitis B/C serology, VDRL, and other infectious disease panels critical for psychiatric patients on immunosuppressive medications or with comorbid infections.' },
    { id: '04', name: 'STAT Emergency Lab', badge: '24/7 Rapid', color: 'bg-red-950', accent: 'text-red-400', badgeColor: 'bg-red-400/10 text-red-400', desc: 'Around-the-clock rapid analysis laboratory serving the Emergency Department with turnaround times under 30 minutes for critical investigations including toxicology screens, blood gases, and emergency metabolic panels.' },
];

const stats = [
    { value: 'STAT', label: 'Emergency Results', icon: '⚡' },
    { value: 'Full', label: 'Diagnostic Panel', icon: '🧪' },
    { value: '24/7', label: 'Emergency Lab', icon: '🕐' },
    { value: 'On-site', label: 'Same-Day Results', icon: '✅' },
];
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Laboratory <br /><span className="text-gray-400 italic font-medium">Services</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Full-spectrum clinical laboratory services providing accurate, rapid diagnostic results to support evidence-based treatment decisions.
                            </p>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                <a href="tel:+2511118685385" className="px-10 py-5 bg-white text-blue-950 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-blue-50 transition-all shadow-2xl hover:-translate-y-1 flex items-center gap-2">
                                    <PhoneIcon className="w-5 h-5" /> Contact Lab
                                </a>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Chemistry · Hematology · Microbiology · STAT Emergency Lab</span>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">
                                    Accurate Diagnostics <br /><span className="text-blue-900">Powering Better Care</span>
                                </h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>
                                        Accurate laboratory diagnostics are the backbone of safe and effective clinical management. EMSH's clinical laboratory provides a comprehensive range of analyses — from routine biochemistry to emergency toxicology — using modern, calibrated equipment and stringent quality control processes.
                                    </p>
                                    <p>
                                        All laboratory services are staffed by certified medical laboratory scientists and aligned with national and international quality assurance standards, ensuring every result you receive is accurate, reliable, and timely.
                                    </p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Drug Level Monitoring', 'Thyroid Function Tests', 'Blood Group & Cross-match', 'Toxicology Screening', 'HIV & Hepatitis Testing', 'Urinalysis & Culture'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Clinical Laboratory</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Lab Department</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    ...
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">Rapid Results</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            <span className="section-badge mb-4">🧪 Our Labs</span>
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Laboratory Units</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Four specialized laboratory sections delivering the full diagnostic spectrum needed for comprehensive clinical care.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter shadow-sm">Request Laboratory Tests</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                Outpatient lab tests available Sunday–Friday. Emergency STAT testing available 24/7 for inpatient and emergency cases.
                            </p>
