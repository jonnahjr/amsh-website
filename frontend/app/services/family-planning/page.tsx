...
const units = [
    { id: '01', name: 'Family Planning Clinic', badge: 'Outpatient', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Scheduled family planning consultations providing personalized contraceptive counseling, method selection support, and ongoing follow-up — with full consideration of psychiatric medications that may interact with hormonal contraceptives.' },
    { id: '02', name: 'Contraceptive Methods Unit', badge: 'Methods', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Provision of a full range of modern contraceptive methods including DMPA injectable, oral contraceptive pills, IUCD insertion, Implanon, and condom distribution with appropriate counseling for each method.' },
    { id: '03', name: 'Reproductive Health Education', badge: 'Education', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Group and individual health education sessions on reproductive health, safe sexual practices, sexually transmitted infection prevention, fertility awareness, and the impact of mental illness and psychotropic medications on reproductive health.' },
    { id: '04', name: 'Psycho-Reproductive Liaison', badge: 'Integrated', color: 'bg-slate-900', accent: 'text-slate-300', badgeColor: 'bg-slate-300/10 text-slate-300', desc: 'Specialist liaison service addressing the intersection of psychiatric and reproductive health — including management of pregnancy in women with serious mental illness, postpartum psychiatric care, and fertility counseling for patients on psychotropic medications.' },
];

const stats = [
    { value: 'Full', label: 'Contraceptive Range', icon: '👪' },
    { value: 'Safe', label: 'Integrated Care', icon: '🔗' },
    { value: 'Daily', label: 'Outpatient Clinics', icon: '📅' },
    { value: 'Free', label: 'Accessible Service', icon: '✅' },
];
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Family <br /><span className="text-gray-400 italic font-medium">Planning</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Comprehensive reproductive health and family planning services — uniquely integrated with psychiatric care to support patients in making informed, safe reproductive health choices.
                            </p>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Contraception · Reproductive Education · Psycho-Reproductive Care</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">Reproductive Health and <br /><span className="text-blue-900">Psychiatric Wellbeing</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>EMSH's Family Planning service recognizes the profound intersection between psychiatric health and reproductive wellbeing. Our clinic is uniquely positioned to provide comprehensive counseling and method provision for patients managing mental health conditions.</p>
                                    <p>Our specialists are experts in understanding how psychotropic medications interact with various contraceptive methods, ensuring that every patient receives a tailored, safe, and effective plan that respects their reproductive rights and clinical needs.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Method Consultation', 'Hormonal Contraception', 'Long-Acting Methods', 'STI Prevention Education', 'Patient Advocacy', 'Confidential Counseling'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Family Planning Clinic</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Reproductive Health Unit</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    ...
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">Counseling</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Family Planning Services</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Four integrated services covering the full spectrum of reproductive care.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">Book Family Planning Consultation</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                Walk-in and appointment-based services available. Services are free of charge for eligible patients.
                            </p>
