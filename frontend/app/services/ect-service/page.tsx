...
const units = [
    { id: '01', name: 'ECT Suite', badge: 'Procedure Room', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'A dedicated, purpose-built ECT suite equipped with modern ECT delivery devices, anaesthetic monitoring, and recovery facilities. All procedures are performed under modified technique with general anaesthesia and muscle relaxation for patient comfort and safety.' },
    { id: '02', name: 'Pre-ECT Assessment Clinic', badge: 'Assessment', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Comprehensive pre-procedure assessment including psychiatric evaluation, anaesthetic review, medical clearance, cognitive baseline assessment (MMSE), and patient/family informed consent — ensuring appropriate candidate selection and procedural safety.' },
    { id: '03', name: 'Post-ECT Recovery Unit', badge: 'Recovery', color: 'bg-emerald-950', accent: 'text-emerald-400', badgeColor: 'bg-emerald-400/10 text-emerald-400', desc: 'Monitored post-anaesthetic recovery with nursing observation, vital sign monitoring, and cognitive re-orientation support before returning to the ward. Side effect management and response assessment documented after every session.' },
    { id: '04', name: 'ECT Response & Follow-up Clinic', badge: 'Follow-up', color: 'bg-slate-900', accent: 'text-slate-300', badgeColor: 'bg-slate-300/10 text-slate-300', desc: 'Systematic monitoring of treatment response, cognitive side effects, and clinical progress throughout the ECT course. Psychiatrist-led review after every session with dose titration and continuation/maintenance ECT planning.' },
];

const stats = [
    { value: 'Modified', label: 'ECT Technique', icon: '📉' },
    { value: 'GA', label: 'Full Anaesthesia', icon: '💉' },
    { value: 'Safe', label: 'International Protocol', icon: '🛡️' },
    { value: 'Expert', label: 'Psychiatrist-Led', icon: '👨‍⚕️' },
];

export default function ECTServicePage() {
    return (
        <>
            <EmergencyBanner />
            <Navbar />
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                ECT <br /><span className="text-gray-400 italic font-medium">Service</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Advanced Electroconvulsive Therapy (ECT) for severe, treatment-resistant psychiatric conditions — delivered under general anaesthesia using modern, modified technique.
                            </p>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                <a href="tel:+2511118685385" className="px-10 py-5 bg-white text-blue-950 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-blue-50 transition-all shadow-2xl hover:-translate-y-1 flex items-center gap-2">
                                    <PhoneIcon className="w-5 h-5" /> ECT Referral
                                </a>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Modified ECT · General Anaesthesia · Evidence-Based · International Protocol</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">When Other Treatments <br /><span className="text-blue-900">Have Not Worked</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>ECT is one of the most effective treatments available in psychiatry for conditions such as severe treatment-resistant depression, acute mania, catatonia, and severe suicidality. Decades of clinical evidence and international guidelines consistently support ECT as a safe and highly effective intervention when appropriately indicated.</p>
                                    <p>At EMSH, ECT is administered by consultant psychiatrists in collaboration with specialist anaesthesiologists, using internationally recognized modified technique (brief-pulse, bilateral/unilateral electrode placement) under general anaesthesia with strict monitoring throughout the procedure.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Treatment-Resistant Depression', 'Severe Bipolar Mania', 'Acute Catatonia', 'Neuroleptic Malignant Syndrome', 'Life-Threatening Suicidality', 'Severe Post-Partum Psychosis'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">ECT Suite</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH ECT Unit</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    ...
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">& Effective</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            <span className="section-badge mb-4">📉 ECT Pathway</span>
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">ECT Clinical Pathway</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                A structured four-stage clinical pathway ensuring safe, ethical, and evidence-based ECT delivery.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">ECT Referrals</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                ECT is available for both inpatients and outpatients. Referrals accepted from psychiatrists. All patients undergo comprehensive pre-ECT assessment before commencing treatment.
                            </p>
