...
const units = [
    { id: '01', name: 'Occupational Therapy Unit', badge: 'OT', color: 'bg-emerald-950', accent: 'text-emerald-400', badgeColor: 'bg-emerald-400/10 text-emerald-400', desc: 'Structured occupational therapy assessments and interventions focusing on activities of daily living (ADL), work rehabilitation, cognitive-functional recovery, and developing practical skills to support independent living and community participation.' },
    { id: '02', name: 'Art Therapy Studio', badge: 'Art Therapy', color: 'bg-violet-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'A dedicated therapeutic space where patients engage in creative expression through visual art, clay work, music, and other artistic mediums as a non-verbal therapeutic modality — supporting emotional processing, self-esteem, and psychological recovery.' },
    { id: '03', name: 'Vocational Rehabilitation Program', badge: 'Vocational', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Skills-based training and vocational preparation for patients approaching discharge or community reintegration. Covers basic work skills, money management, social interaction, and practical life skills for sustainable independent living.' },
    { id: '04', name: 'Recreational & Social Activities', badge: 'Group Activities', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Supervised group activities including exercise programs, music sessions, drama therapy, horticultural therapy, and recreational games — structured to enhance mood, build social confidence, and provide meaningful engagement during treatment.' },
];

const stats = [
    { value: 'OT', label: 'Occupational Therapy', icon: '🎨' },
    { value: 'Art', label: 'Creative Therapy', icon: '🖌️' },
    { value: 'Life', label: 'Skills Training', icon: '🏠' },
    { value: 'Group', label: 'Recreational Programs', icon: '🤝' },
];

export default function OccupationalArtTherapyPage() {
    return (
        <>
            <EmergencyBanner />
            <Navbar />
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Occupational & Art <br /><span className="text-gray-400 italic font-medium">Therapy</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Rehabilitative therapy using purposeful occupations and creative expression to support mental health recovery, enhance daily functioning, and reintegrate patients into meaningful community roles.
                            </p>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                <a href="tel:+2511118685385" className="px-10 py-5 bg-white text-blue-950 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-blue-50 transition-all shadow-2xl hover:-translate-y-1 flex items-center gap-2">
                                    <PhoneIcon className="w-5 h-5" /> Book Session
                                </a>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Occupational Therapy · Art Therapy · Vocational Rehab · Social Recreation</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">Healing Through <br /><span className="text-blue-900">Purpose & Creativity</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>Occupational and art therapy are essential components of psychiatric rehabilitation, addressing the functional, creative, and social dimensions of recovery that medication alone cannot achieve. At EMSH, our occupational therapists and art therapists work within the multidisciplinary team to restore patients' capacity for independent, meaningful daily life.</p>
                                    <p>Evidence consistently shows that purposeful occupation and creative engagement accelerate psychiatric recovery, improve quality of life, reduce recurrence, and increase the likelihood of successful community reintegration following psychiatric hospitalization.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Activities of Daily Living', 'Creative Art Expression', 'Social Skills Training', 'Work Rehabilitation', 'Sensory Integration', 'Life Skills Coaching'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">OT & Art Therapy Unit</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Therapy Studio</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-emerald-800 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    <div className="text-2xl font-black">OT</div>
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">& Art</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            <span className="section-badge mb-4">🎨 Our Programs</span>
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Therapy Programs</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Four therapy programs integrating occupational rehabilitation and creative healing modalities.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">Refer to Occupational & Art Therapy</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                Referrals accepted from psychiatrists, psychologists, nurses, and medical staff. OT and art therapy are integrated into inpatient and outpatient treatment programs.
                            </p>
