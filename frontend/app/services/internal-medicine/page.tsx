...
const units = [
    { id: '01', name: 'General Internal Medicine Ward', badge: 'Inpatient', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'Management of complex adult medical conditions including cardiovascular disease, diabetes mellitus, hypertension, renal disease, and other chronic conditions requiring specialist physician oversight.' },
    { id: '02', name: 'Outpatient Medical Clinic', badge: 'Outpatient', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Scheduled consultations for ongoing management of chronic conditions, medication reviews, specialist referrals, and follow-up care for post-hospital patients.' },
    { id: '03', name: 'Integrated Medical-Psychiatric Clinic', badge: 'Integrated', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'A uniquely integrated service addressing the complex interplay between physical and psychiatric illness, providing holistic care for patients with co-morbid conditions — a model increasingly recognized internationally.' },
    { id: '04', name: 'Chronic Disease Management', badge: 'Longitudinal', color: 'bg-slate-900', accent: 'text-slate-300', badgeColor: 'bg-slate-300/10 text-slate-300', desc: 'Structured long-term care programs for patients with hypertension, type 2 diabetes, thyroid disorders, epilepsy, and HIV/AIDS — emphasizing lifestyle modification, medication adherence, and regular monitoring.' },
];

const stats = [
    { value: '4', label: 'Clinical Units', icon: '🩺' },
    { value: 'Daily', label: 'Outpatient Clinics', icon: '📅' },
    { value: 'ISO', label: 'Quality Standards', icon: '✅' },
    { value: '100%', label: 'Specialist-Led', icon: '👨‍⚕️' },
];
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Internal Medicine <br /><span className="text-gray-400 italic font-medium">Services</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                Expert internal medicine care — uniquely integrated with psychiatric expertise — for the comprehensive management of complex adult medical and co-morbid conditions.
                            </p>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Specialist-Led · Evidence-Based · Holistic Care</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">Bridging Physical & <br /><span className="text-blue-900">Mental Health</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>EMSH's Internal Medicine Service provides specialist-led care for adults with medical conditions, operating within a uniquely integrated framework that recognizes the deep connection between physical and mental health. This positions us as a pioneer in holistic patient care in East Africa.</p>
                                    <p>Our internists work alongside psychiatrists, pharmacists, and allied health professionals, ensuring that each patient's complete health picture is addressed in a coordinated, evidence-based manner aligned with international clinical guidelines.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Chronic Disease Management', 'Cardiovascular Care', 'Diabetes & Endocrinology', 'Renal Medicine', 'HIV/AIDS Management', 'Nutritional Medicine'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Internal Medicine Ward</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Medical Department</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    ...
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">Specialist Care</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Clinical Units</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Four integrated clinical units delivering specialist internal medicine care within EMSH's holistic framework.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter shadow-sm">Book an Internal Medicine Consultation</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                Our specialist physicians are available Monday to Friday for outpatient consultations, and inpatient referrals are accepted 24/7.
                            </p>
