...
const units = [
    { id: '01', name: 'Prescription Dispensing', badge: 'Public', color: 'bg-blue-950', accent: 'text-cyan-400', badgeColor: 'bg-cyan-400/10 text-cyan-400', desc: 'A full-service pharmacy open to the general community, providing both psychiatric and general medications with accurate dispensing and professional pharmacist guidance.' },
    { id: '02', name: 'OTC Medication Corner', badge: 'Over-the-Counter', color: 'bg-indigo-950', accent: 'text-violet-400', badgeColor: 'bg-violet-400/10 text-violet-400', desc: 'Providing safe access to over-the-counter medications for common ailments, with health education on minor illness management and proper medication usage.' },
    { id: '03', name: 'Medication Counseling', badge: 'Guidance', color: 'bg-emerald-950', accent: 'text-emerald-400', badgeColor: 'bg-emerald-400/10 text-emerald-400', desc: 'Individualized counseling sessions where patients and families learn about their medications, including proper dosage, potential side effects, and strategies to improve treatment adherence.' },
    { id: '04', name: 'Health Wellness Lab', badge: 'Awareness', color: 'bg-teal-950', accent: 'text-teal-400', badgeColor: 'bg-teal-400/10 text-teal-400', desc: 'Promoting community health through awareness programs on mental health medication, chronic disease management, and standard healthy living practices.' },
];

const stats = [
    { value: 'Public', label: 'Access', icon: '🏪' },
    { value: 'Daily', label: 'Availability', icon: '💊' },
    { value: 'Expert', label: 'Counseling', icon: '👩‍⚕️' },
    { value: 'Full', label: 'Inventory', icon: '📦' },
];
                    ...
                    <div className="container-custom relative z-10 py-24 -translate-y-10">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white leading-[1.1] mb-8 animate-fade-in-up tracking-tighter" style={{ animationDelay: '0.1s' }}>
                                Community <br /><span className="text-gray-400 italic font-medium">Pharmacy</span>
                            </h1>
                            <p className="text-lg md:text-2xl text-blue-100/80 max-w-3xl mb-12 leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: '0.2s' }}>
                                A full-service, public-facing pharmacy accessible to the general community for psychiatric and general medical needs, providing trusted medication and wellness support.
                            </p>
                            ...
                            <div className="mt-12 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                ...
                                <span className="text-blue-200 text-sm font-black uppercase tracking-widest">Prescriptions · OTC Medications · Wellness Counseling</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">Your Community <br /><span className="text-blue-900">Health Partner</span></h2>
                                <div className="space-y-5 text-gray-600 leading-relaxed font-medium">
                                    <p>The Community Pharmacy at Emmanuel Mental Specialized Hospital extends our pharmaceutical expertise beyond the hospital walls, providing a reliable source of high-quality medications for the general public.</p>
                                    <p>Our pharmacists do more than just dispense drugs; they are trusted health partners who provide medication reconciliation, adherence support, and personalized counseling to ensure that every community member understands their treatment plan and uses their medication safely and effectively.</p>
                                </div>
                                <div className="mt-10 grid grid-cols-2 gap-4">
                                    {['Chronic Meds Management', 'Mental Health Meds', 'General Prescriptions', 'OTC Medicines', 'Professional Counseling', 'Confidential Care'].map(item => (
                            ...
                            <div className="relative">
                                <div className="w-full h-[520px] bg-gradient-to-br from-blue-950 to-blue-900 rounded-[3rem] overflow-hidden flex flex-col items-center justify-center gap-4 border border-blue-800/30 shadow-2xl">
                                    ...
                                    <div className="text-center px-8">
                                        <p className="text-white font-black text-lg mb-2">Community Pharmacy</p>
                                        <p className="text-blue-300/60 text-sm">Photo — EMSH Public Pharmacy</p>
                                    </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white rounded-3xl px-6 py-4 shadow-2xl">
                                    ...
                                    <div className="text-xs font-black uppercase tracking-widest opacity-80">to Community</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-28 bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-20">
                            <span className="section-badge mb-4">🏪 Community Care</span>
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6">Pharmacy Services</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                                Integrated community pharmacy programs providing medication access and professional health support.
                            </p>
                        </div>
                ...
                <section className="py-20 bg-blue-950 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 text-center">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter">Pharmacy Walk-ins Welcome</h2>
                            <p className="text-blue-200/60 text-lg mb-10 leading-relaxed">
                                Accessible during standard service hours. Bring your prescription from any registered health facility.
                            </p>
