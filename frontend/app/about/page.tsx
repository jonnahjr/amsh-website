                    ...
                    <div className="container-custom">
                        <div className="max-w-7xl mx-auto text-center">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left mt-8">
                                {/* Amharic Column */}
                                <div className="space-y-6 text-gray-500 text-base leading-relaxed border-r border-gray-100 pr-8">
                                    ...
                                    <p className="font-bold text-lg text-blue-900 leading-snug">
                                ...
                                {/* English Column */}
                                <div className="space-y-6 text-gray-600 text-base leading-relaxed pl-0 md:pl-4">
                                    <div className="flex items-center gap-2 mb-4">
