...
export const metadata: Metadata = {
    title: 'Media Kit | Emmanuel Mental Specialized Hospital',
    description: 'Downloadable corporate assets, official logos, and branding guidelines for media partners.',
};
            ...
            <main className="bg-gray-50 min-h-screen">
                    ...
                    <div className="container-custom relative z-10 py-24 text-center">
                        <div className="max-w-4xl mx-auto">
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-[1.1] mb-6 tracking-tighter">
                                Media <span className="text-gray-400 italic font-medium">Kit</span>
                            </h1>
                            <p className="text-lg text-blue-100/60 max-w-2xl mx-auto leading-relaxed font-medium">
                                High-resolution logos, brand guidelines, and official hospital imagery for press usage.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="section">
                    <div className="container-custom py-16 text-center">
                        ...
                        <h2 className="text-2xl font-black text-gray-900 mb-4">Media Assets Updating</h2>
                        <p className="text-gray-500 max-w-lg mx-auto mb-8">
                            We are currently organizing our high-resolution galleries and brand guidelines. These resources will be available to download soon.
                        </p>
