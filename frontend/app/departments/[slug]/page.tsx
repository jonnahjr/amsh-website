            ...
            <main className="bg-white">
                ...
                <section className="relative min-h-[70vh] bg-blue-950 flex items-end overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 pb-20 pt-40">
                        {/* Breadcrumb */}
                        <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/40 mb-8">
                            <Link href="/" className="hover:text-white/80">Home</Link>
                            <ChevronRightIcon className="w-3 h-3" />
                            <Link href="/departments" className="hover:text-white/80">Departments</Link>
                            <ChevronRightIcon className="w-3 h-3" />
                            <span className="text-white/80">{dept.name}</span>
                        </div>

                        <div className="max-w-4xl">
                            <div className="inline-flex items-center gap-3 px-5 py-2 bg-cyan-500/20 border border-cyan-400/30 rounded-full text-cyan-300 text-[10px] font-black uppercase tracking-widest mb-6">
                                <BuildingOfficeIcon className="w-4 h-4" />
                                EMSH Department · {dept.services?.length || 0} Services
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Link href="/contact" className="px-10 py-5 bg-white text-blue-950 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-blue-50 transition-all shadow-2xl hover:-translate-y-1">
                                    Book Appointment
                                </Link>
                                <a href="tel:+2511118685385" className="inline-flex items-center gap-2 px-10 py-5 border-2 border-white/20 text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-white/10 transition-all">
                ...
                <div className="container-custom py-20 max-w-5xl space-y-32">
                    ...
                    {/* Bottom CTA */}
                    <div className="mt-20 bg-blue-900 rounded-[48px] p-12 text-center text-white">
                        <h3 className="text-2xl font-black mb-3 tracking-tighter">Ready to get started?</h3>
                        <p className="text-blue-200 mb-8 font-medium">Contact us to schedule a consultation with our team.</p>
                        <div className="flex flex-wrap justify-center gap-4">
                            ...
                            <Link href="/departments" className="px-10 py-5 bg-white/10 border border-white/20 text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-white/20 transition-all">
                                ← All Departments
                            </Link>
                        </div>
                    </div>
