    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-10 pb-20 animate-fade-in">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <span className="px-3 py-1 bg-blue-950 text-white text-[9px] font-black uppercase tracking-widest rounded-full shadow-lg shadow-blue-950/20">System Status: Live</span>
                        ...
                        <h2 className="text-4xl font-black text-blue-950 tracking-tighter leading-none mb-4">
                            Welcome Back, <span className="text-blue-950">Chief Admin</span>
                        </h2>
                        <p className="text-gray-500 font-medium max-w-lg leading-relaxed">
                            Your operational heartbeat is healthy. We've detected <span className="text-blue-950 font-bold">12 new applications</span> in the last 24 hours that require your attention.
                        </p>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <button className="flex items-center gap-2 px-8 py-4 bg-blue-950 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-950 transition-all shadow-2xl shadow-blue-950/30 group">
                ...
                {stats.map((stat, idx) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-8 relative z-10">
                            <div className={`p-4 rounded-2xl shadow-lg shadow-${stat.color}-900/10 ${stat.color === 'blue' ? 'bg-blue-950 text-white' :
                        ...
                        <div className="relative z-10 mb-2">
                            <span className="text-4xl font-black text-blue-950 tracking-tighter">{stat.value}</span>
                        </div>
                ...
                <div className="lg:col-span-8 space-y-8">
                    <div className="bg-white border border-gray-50 rounded-[3.5rem] p-10 shadow-sm">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-12">
                            <div>
                                <h3 className="text-2xl font-black text-blue-950 tracking-tighter mb-1">Operational Flow</h3>
                            ...
                            <div className="flex bg-gray-50 p-1.5 rounded-2xl">
                                {['OVERVIEW', 'ATTACHMENTS', 'CPD'].map((tab) => (
                                    <button
                                        ...
                                        className={`px-6 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-blue-950 text-white shadow-lg' : 'text-gray-400 hover:text-gray-900'
                                            }`}
                                    >
                                        {tab}
                                    </button>
                        ...
                        {activeTab === 'OVERVIEW' && (
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 animate-fade-in-up">
                                <div className="space-y-6">
                                    <div className="bg-gradient-to-br from-blue-950 to-blue-800 p-8 rounded-[2.5rem] text-white shadow-2xl shadow-blue-950/20 group">
                                    ...
                                    <div className="bg-gray-50 p-8 rounded-[2.5rem] border border-gray-100 flex items-center justify-between">
                                        <div>
                                            <div className="text-3xl font-black text-blue-950 mb-1">{data?.stats?.totalMessages || 0}</div>
                                            <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Active Conversations</div>
                                        </div>
                                        <Link href="/admin/messages" className="p-4 bg-white rounded-2xl shadow-sm hover:shadow-md transition-all text-blue-950">
                                ...
                                <div className="bg-white border-2 border-dashed border-gray-100 p-8 rounded-[2.5rem] flex flex-col justify-center text-center">
                                    <div className="w-20 h-20 bg-blue-50 text-blue-950 rounded-[2rem] flex items-center justify-center mx-auto mb-6">
                                        <PlusIcon className="w-8 h-8" />
                                    </div>
                                    <h5 className="font-black text-blue-950 uppercase tracking-tighter mb-2">Integrate Service</h5>
                                    <p className="text-xs text-gray-400 mb-6">Add new clinical modules or departments to the public platform.</p>
                                    <button className="px-6 py-3 bg-blue-950 text-white rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-blue-950 transition-all">Start Integration</button>
                                </div>
                            </div>
                        )}
                        ...
                        {(activeTab === 'ATTACHMENTS' || activeTab === 'CPD') && (
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up">
                                {[
                                    ...
                                    return (
                                        <div key={cat.key} className="bg-white border border-gray-100 p-8 rounded-[2.5rem] hover:border-blue-950/20 group transition-all">
                                            <div className={`w-12 h-12 rounded-xl mb-6 flex items-center justify-center ${cat.color === 'blue' ? 'bg-blue-50 text-blue-950' :
                                                    cat.color === 'emerald' ? 'bg-emerald-50 text-emerald-900' :
                                                        'bg-purple-50 text-purple-900'
                                                }`}>
                                                <cat.icon className="w-6 h-6" />
                                            </div>
                                            <div className="text-4xl font-black text-blue-950 mb-2">{val || 0}</div>
                                            <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-6">{cat.label}</div>
                                            <Link href={link} className="flex items-center gap-2 text-[9px] font-black uppercase tracking-widest text-blue-950 group-hover:gap-3 transition-all">
                    ...
                    <div className="bg-white border border-gray-50 rounded-[3.5rem] p-10 shadow-sm relative overflow-hidden">
                        <div className="flex items-center justify-between mb-12">
                            <div>
                                <h3 className="text-2xl font-black text-blue-950 tracking-tighter mb-1">Inflow Velocity</h3>
                        ...
                        <div className="h-48 flex items-end justify-between gap-4 sm:gap-8 px-4">
                            {[45, 62, 51, 88, 76, 92, 68].map((height, i) => (
                                <div key={i} className="flex-1 flex flex-col items-center gap-4 group">
                                    <div
                                        className="w-full bg-gray-100 group-hover:bg-blue-950 rounded-full transition-all duration-700 relative flex items-end"
                                        style={{ height: `${height}%` }}
                                    >
                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-blue-950 text-white text-[9px] font-black px-2.5 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 whitespace-nowrap shadow-xl">
                                            {height} APPS
                                        </div>
                                    </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="bg-white border border-gray-50 rounded-[3.5rem] p-10 shadow-sm h-full flex flex-col">
                        <div className="flex items-center justify-between mb-10">
                            <div>
                                <h3 className="text-2xl font-black text-blue-950 tracking-tighter mb-1">Realtime</h3>
                        ...
                        <div className="space-y-4 flex-1">
                            {(data?.recent?.applications || []).map((app: any, i: number) => (
                                <div key={i} className="p-6 bg-gray-50 rounded-3xl border border-transparent hover:border-blue-950/10 hover:bg-white transition-all group cursor-pointer">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center font-black text-blue-950 group-hover:bg-blue-950 group-hover:text-white transition-all">
                                            {app.firstName.charAt(0)}
                                        </div>
                                        <div className="flex-1">
                                            <div className="text-sm font-black text-blue-950 truncate">{app.firstName} {app.lastName}</div>
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-100/50">
                                        ...
                                        <span className="px-2.5 py-1 bg-white rounded-lg text-[8px] font-black uppercase text-blue-950 shadow-sm border border-gray-100">
                                            {app.status}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <Link href="/admin/clinical-attachments" className="mt-10 w-full py-5 bg-blue-950 text-white rounded-[2rem] text-[9px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 hover:bg-blue-950 transition-all group shadow-xl shadow-blue-950/20">
            ...
            <div className="space-y-8">
                <div className="flex items-center gap-4">
                    <h3 className="text-2xl font-black text-blue-950 tracking-tighter">System Core</h3>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-6 gap-6">
                    {[
                        ...
                        <Link
                            key={item.label}
                            href={item.href}
                            className="p-8 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm hover:scale-[1.03] hover:shadow-2xl hover:shadow-blue-950/10 hover:border-blue-950/20 group transition-all"
                        >
                            <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:bg-blue-950 group-hover:scale-110 transition-all">
                                {item.icon}
                            </div>
