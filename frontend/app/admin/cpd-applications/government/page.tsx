...
export default function GovernmentCpdApplications() {
    ...
    const fetchRegistrations = async () => {
        ...
        try {
            ...
            // Filter by GOVERNMENT category
            const filtered = (res.data.registrations || []).filter((r: any) => r.category === 'GOVERNMENT');
        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-emerald-900 text-white flex items-center justify-center shadow-lg shadow-emerald-900/20">
                        <BuildingLibraryIcon className="w-6 h-6" />
                    </div>
                    <div>
                        <h2 className="text-2xl font-black text-gray-900">Government CPD</h2>
                        <p className="text-gray-500 text-sm">Applications from public health institutions.</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <button 
                        onClick={() => exportToCSV(registrations, 'Government_CPD_Export')}
            ...
            <div className="grid grid-cols-1 gap-4">
                {loading ? (
                    ...
                    <div className="bg-white p-20 rounded-[40px] border border-gray-50 text-center">
                        <BuildingLibraryIcon className="w-16 h-16 text-gray-100 mx-auto mb-4" />
                        ...
                        <div key={reg.id} className="bg-white p-6 md:p-8 rounded-[32px] border border-gray-50 shadow-sm hover:shadow-md transition-all group">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                <div className="flex items-start gap-4">
                                    <div className="w-14 h-14 rounded-2xl bg-emerald-50 flex items-center justify-center text-emerald-900 flex-shrink-0 group-hover:scale-110 transition-transform">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mb-2">
                                            <span className="text-[10px] font-black text-emerald-900 uppercase tracking-wider bg-emerald-50 px-2 py-0.5 rounded mr-2">
                                                GOVERNMENT
                                            </span>
                                ...
                                <div className="flex items-center gap-2">
                                    <button 
                                        ...
                                        className="flex-1 md:flex-none px-6 py-3 bg-gray-50 hover:bg-emerald-900 hover:text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
                                    >
                                        View Details
                                    </button>
                                    <button
