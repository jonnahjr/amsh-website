...
export default function PersonalCpdApplications() {
    ...
    const fetchRegistrations = async () => {
        ...
        try {
            ...
            const filtered = (res.data.registrations || []).filter((r: any) => r.category === 'PERSONAL');
        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-black text-gray-900">Personal / Independent CPD</h2>
                        <p className="text-gray-500 text-sm">Applications from individual health professionals.</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 gap-4">
                {loading ? (
                    ...
                    <div className="bg-white p-20 rounded-[40px] border border-gray-50 text-center">
                        <UserIcon className="w-16 h-16 text-gray-100 mx-auto mb-4" />
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mb-2">
                                            <span className="text-[10px] font-black text-amber-900 uppercase tracking-wider bg-amber-50 px-2 py-0.5 rounded mr-2">
                                                PERSONAL
                                            </span>
