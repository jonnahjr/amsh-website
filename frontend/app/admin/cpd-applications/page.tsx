    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-black text-gray-900">CPD Applications</h2>
                    <p className="text-gray-500 text-sm">Manage course registrations and professional development applicants.</p>
                </div>
                    ...
                    filtered.map((reg) => (
                        <div key={reg.id} className="bg-white p-6 md:p-8 rounded-[32px] border border-gray-50 shadow-sm hover:shadow-md transition-all group">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            <h3 className="font-black text-gray-900 text-lg leading-tight">{reg.fullName}</h3>
                                ...
                                <div className="flex items-center gap-2">
                                    <button className="flex-1 md:flex-none px-6 py-3 bg-gray-50 hover:bg-blue-900 hover:text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">View Details</button>
                                    <button
