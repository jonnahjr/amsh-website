    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-black text-gray-900">Clinical Attachments</h2>
                    <p className="text-gray-500 text-sm">Review and manage institutional and individual attachment requests.</p>
                </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                <h3 className="font-black text-gray-900 text-lg leading-tight">{data.institutionName || 'Unknown Applicant'}</h3>
